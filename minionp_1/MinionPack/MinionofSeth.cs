...
{
	[CorpseName( "a body" )]
	public class MinionofSeth : BaseCreature
	{
		...
		[Constructable]
		public MinionofSeth() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a follower of Sethrodemus";
			Body = 0x3CA;
			Hue = 0x453;
			BaseSoundID = 0x482;
		...
		public MinionofSeth( Serial serial ) : base( serial )
		{
		}
